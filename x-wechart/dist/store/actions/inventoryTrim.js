...
// 获取库存调整列表
exports.getInventoryList = redux_actions_1.createAction(inventoryTrim_1.GET_INVENTORY_LIST, function (dataList) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
// 获取事务类型、单据状态列表信息
exports.getBaseInfo = redux_actions_1.createAction(inventoryTrim_1.GET_BASE_INFO, function () { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dmsrequest_1.dmsRequest({
...
// 仓库查询接口
exports.getStoreHouse = redux_actions_1.createAction(inventoryTrim_1.GET_STORE_HOUSE, function (_a) {
    var orgId = _a.orgId;
