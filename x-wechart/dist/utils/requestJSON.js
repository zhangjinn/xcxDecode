...
exports.request = function (_a, sys) {
    var api = _a.api, _b = _a.method, method = _b === void 0 ? 'GET' : _b, data = _a.data, _c = _a.header, header = _c === void 0 ? {} : _c, callback = _a.callback;
    ...
    return new Promise(function (resolve, reject) {
        ...
        wepy_1.default.request({
            ...
            header: __assign({ 'content-type': 'application/json' }, header),
            success: function (res) {
                ...
                if ((!dmsRequest && successStatus) || (dmsRequest && successStatus && successMsg)) {
                    ...
                    if (!IGNORE_MSG[data.message || data.msg || '--'] && !ignoreToastError) {
                        wx.showToast({
                            title: STATUS_CODE[data.message] || data.message || data.msg || '系统错误,请稍后重试',
                            duration: 2000,
                            icon: 'none',
                            mask: false,
                        });
