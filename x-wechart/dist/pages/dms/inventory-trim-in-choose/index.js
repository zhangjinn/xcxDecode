...
var OrderItemChoose = /** @class */ (function (_super) {
    ...
    function OrderItemChoose() {
        ...
        _this.methods = {
            ...
            onSearch: function (_a) {
                ...
                var detail = _a.detail;
                wepy_redux_1.getStore().dispatch({ type: inventory_1.RESET_INVENTORY_QUERIES_LIST_IN, payload: [] });
                _this.model = detail;
                _this.myGetOrderList(detail, _this.pageNo);
            },
            // 选择入库产品信息
            chooseItem: function (index) {
                //const chooseItem = this.likePaging[index]
                var oneItem = _this.inventoryListIn[index];
                var chooseItem = {
    ...
    OrderItemChoose.prototype.myGetOrderList = function (model, pageNo) {
        ...
        this.methods.getInventoryQueriesListIn({
    ...
    OrderItemChoose = __decorate([
        wepy_redux_1.connect({
            ...
            getInventoryQueriesListIn: inventory_2.getInventoryQueriesListIn
        })
    ], OrderItemChoose);
    return OrderItemChoose;
}(wepy_1.default.page));

Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(OrderItemChoose , 'pages/dms/inventory-trim-in-choose/index'));
