...
var ChannelOrder = /** @class */ (function (_super) {
    ...
    function ChannelOrder() {
        ...
        _this.$repeat = {};
        _this.$props = { "order": { "ly": "channelNew", "xmlns:v-bind": "", "v-bind:isDisabled.sync": "isDisabled" }, "popup": { "title": "创建渠道订单失败" } };
        _this.$events = {};
        _this.components = {
        ...
        _this.methods = {
            ...
            sendRequest: function (status) { return __awaiter(_this, void 0, void 0, function () {
                var chooseCustomerInfo, _a, org, sendInventoryInfo, receiveUnitInfo, receiveInventoryInfo, receiverInfo, saleType, invoiceInfo, saler, note, deliveryMethod, params, paramObj, index, param, key, systemParametersObj, systemParameters, _b, _c, _i, idx, org_1, matklId, gicWarehouseType, isOpenSharedWarehouseObj, isOpenSharedWarehouse, time, orderInfo;
                var _this = this;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            if (!(systemParameters == 'Y')) return [3 /*break*/, 5];
                            _b = [];
                            for (_c in params)
                                _b.push(_c);
                            _i = 0;
                        ...
                        case 2:
                            ...
                            idx = _b[_i];
                            org_1 = params[idx].itemInfo.orgCode;
                            matklId = params[idx].itemInfo.materialGroupCode;
                            gicWarehouseType = params[idx].itemInfo.gicWarehouseType;
                            return [4 /*yield*/, this.methods.getIsOpenSharedWarehouse({ orgId: org_1, matklId: matklId })];
                        case 3:
                            isOpenSharedWarehouseObj = _d.sent();
                        ...
                        case 5:
                            ...
                            orderInfo = {
                                salesOrder: {
                                    ...
                                    salesOrderItem: params.map(function (param) {
                                        ...
                                        return {
                                            orgId: itemInfo.orgCode,
                                            warehouseId: itemInfo.gicWarehouse,
                            ...
                            dialog_1.default.confirm({
                                ...
                                _this.methods.submitChannelOrderNew(__assign({}, orderInfo, { _ignoreToast: true, _popup: true })).then(function (res) {
    ...
    ChannelOrder = __decorate([
        wepy_redux_1.connect({
            ...
            submitChannelOrderNew: dmsorder_1.submitChannelOrderNew,
...
Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(ChannelOrder , 'pages/dms/channel-order-new/index'));
