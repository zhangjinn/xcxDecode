...
var index_4 = require('./../../../components/user-operation/edit-home-appliances/index.js');
...
var IntendedUsersOrder = /** @class */ (function (_super) {
    ...
    function IntendedUsersOrder() {
        ...
        _this.methods = {
            ...
            submit: function () { return __awaiter(_this, void 0, void 0, function () {
                var _a, communityName, houseType, chooseTownInfo, receiverDetail, that, purchaseIntention, checkParams, productList_1, param;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                        ...
                        case 1:
                            if (_b.sent()) {
                                ...
                                if (this.details.hourseProductDtoList && this.details.hourseProductDtoList.length) {
                                    this.details.hourseProductDtoList.forEach(function (item) {
                                        productList_1.push(item);
                                    });
                                }
                                if (purchaseIntention.length) {
                                    purchaseIntention.forEach(function (item) {
                                        var obj = {
                                ...
                                param = {
                                    ...
                                    hourseProductDtoList: productList_1,
                                };
                                this.methods.updateShopPotentialUserDetail(param).then(function (res) {
    ...
    // 潜在客户明细
    IntendedUsersOrder.prototype.getShopPotentialHourseInfo = function () {
        var _this = this;
        this.methods.getShopPotentialHourse({
            ...
            if (_this.details.hourseProductDtoList) {
                _this.details.hourseProductDtoList = _this.details.hourseProductDtoList.map(function (product) {
                    product.categoryPicture = index_5.getBlueCategoryPictures(product.spartId);
                    return product;
                });
            }
            _this.baseFormData = {
                communityName: _this.details.community,
                houseType: _this.details.hourseTypeName,
                chooseProvinceInfo: {
    ...
    IntendedUsersOrder = __decorate([
        wepy_redux_1.connect({
            ...
            updateShopPotentialUserDetail: order_1.updateShopPotentialUserDetail,
...
Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(IntendedUsersOrder , 'pages/operation/edit-house-appliances/index'));
