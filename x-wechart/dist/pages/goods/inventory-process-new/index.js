...
var Filter = /** @class */ (function (_super) {
        ...
        _this.methods = {
            ...
            selectagentPopup: function (e) {
                if (e == 'ckmc') {
                    ...
                    _this.popupTitle = '查看账户';
                }
                else if (e == 'swlx') {
                    _this.popupTitle = '业务类型';
                }
                else if (e == 'kcsw') {
                    _this.popupTitle = '库存事务';
                }
                else if (e == 'xszz') {
            ...
            onResetFilterForm: function () {
                ...
                var day = now.getDate();
                this.filterForm = __assign({}, this.filterForm, { model: '', warehouseId: '', stvNum: '', startDate: index_1.getLastMonthYesterday(), endDate: now.getFullYear() + "-" + (month > 9 ? month : "0" + month) + "-" + (day > 9 ? day : "0" + day), materialGroupId: '', inventoryTypeId: '', inventoryStatusId: '', qualityLevelId: '', viewAccountId: [], orgId: '', pageNo: 1 });
            ...
            //单据展开
            isItemShowFun: function (item, index) {
    ...
    Filter.prototype.myGetOrderList = function () {
        var _a = this.filterForm, warehouseId = _a.warehouseId, model = _a.model, startDate = _a.startDate, endDate = _a.endDate, stvNum = _a.stvNum, inventoryTypeId = _a.inventoryTypeId, inventoryStatusId = _a.inventoryStatusId, qualityLevelId = _a.qualityLevelId, viewAccountId = _a.viewAccountId, orgId = _a.orgId, materialGroupId = _a.materialGroupId;
        var terms = {
            ...
            endbizTime: endDate,
            billno: stvNum,
            invType: inventoryTypeId,
            gicInvStatus: inventoryStatusId,
            invStatusId: qualityLevelId,
            allDealerCode: viewAccountId.toString(),
            biztype: '',
            invstatusname: '',
            orgCode: orgId,
            materialgroup: materialGroupId,
        };
        this.methods.findAllInventoryLogNew(wepy_1.default.$instance.globalData.cisCode, terms, this.filterForm.pageNo);
    };
    // 获取销售组织选项列表
    ...
    Filter.prototype.getFilterList = function () {
        ...
        this.methods.getDistributorType({
            ...
            var data = res.payload.data;
            if (data && data.length) {
                _this.inventoryStatusOptions = _this.inventoryStatusOptions.concat(data);
            }
        });
        // 获取质量等级选项列表
        ...
        this.methods.getDistributorType({
            ...
            var data = res.payload.data;
            if (data && data.length) {
                _this.viewAccountOptions = _this.viewAccountOptions.concat(data);
            }
        });
    };
    ...
    Filter = __decorate([
        wepy_redux_1.connect({
            ...
            findAllInventoryLogNew: dmsoutwarehouse_1.findAllInventoryLogNew,
...
Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(Filter , 'pages/goods/inventory-process-new/index'));
