...
var PurchaseShop = /** @class */ (function (_super) {
    ...
    function PurchaseShop() {
        ...
        _this.methods = {
            ...
            // 选择门店
            chooseStore: function (key) {
                _this.stores.forEach(function (res) {
                    if (res.id == key) {
                        res.isSelect = true;
                    }
                    else {
            ...
            OnseleWarehouse: function () {
                var purchaseOrderIds = [], deliveryTypes = [];
                _this.purchaseList.forEach(function (res) {
                ...
                if (deliveryTypes.length == 1 && deliveryTypes.indexOf("04") >= 0) {
                    _this.batchInBtnTxt = '下一步';
                }
                else {
                    _this.batchInBtnTxt = '确认入库';
                }
                if (purchaseOrderIds.length > 0) {
                    _this.WarehouseListvisible = true;
                }
                else {
                    toast_1.default.fail({
                        message: '请选择商品',
            ...
            nextStep: function () {
                ...
                if (_this.batchInBtnTxt == "下一步") {
                    _this.storeListvisible = !_this.storeListvisible;
                }
                else {
            ...
            submitOrder: function (type) {
                ...
                if (purchaseOrderIds.length > 0) {
                    _this.methods.getPurchaseListIn({
                        _loading: true, _ignoreToast: true, warehouseId: _this.Warehouserel, purchaseOrderIds: purchaseOrderIds, storeCode: _this.store
                    }).then(function (res) {
            ...
            closeStores: function () {
                _this.storeListvisible = false;
            },
            // 供应商选择
    ...
    PurchaseShop.prototype.onLoad = function () {
        this.methods.getMerchantSuppliersList({
            ...
            this.methods.getBaseData({
                cisCode: wepy_1.default.$instance.globalData.cisCode, "type": 'cgrkrkck', 'orgId': '', userAccount: wepy_1.default.$instance.globalData.account
            }).then(function (res) {
...
Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(PurchaseShop , 'pages/goods/purchase-shop/index'));
