...
var WebViewPage = /** @class */ (function (_super) {
    ...
    //获取物料组
    WebViewPage.prototype.getMaterialGroup = function () {
        var that = this;
    ...
    //获取门店销售明细
    WebViewPage.prototype.getStoreSaleDetail = function (type) {
        console.log(type);
        var that = this;
        console.log('this.materialGroupCode.toString()', this.materialGroupCode.toString());
        var start = that.startTime.split("-");
        var starttime = start.join("");
        var end = that.endTime.split("-");
        var endtime = end.join("");
        if (type == 2) {
    ...
    WebViewPage.prototype.onPullDownRefresh = function () {
        console.log('来了');
        this.pageNo = 1;
        this.getStoreSaleDetail(2);
    };
    WebViewPage.prototype.onReachBottom = function () {
        this.pageNo = this.pageNo + 1;
        this.getStoreSaleDetail(1);
    };
    return WebViewPage;
...
Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(WebViewPage , 'pages/terminal/dataDetails/index'));
