...
var default_1 = /** @class */ (function (_super) {
    ...
    function default_1() {
        ...
        _this.methods = {
            ...
            getData: function () {
                _this.methods.getMarketCoverage(_this.filterForm).then(function (res1) {
                    var res = res1.payload;
                    var dataArr = [];
                    var result = null;
                    for (var key in res.result) {
                        if (key === _this.filterForm.month) {
                    ...
                    if (result && result.mx) {
                        result.mx.map(function (i) {
                            dataArr.push(__assign({}, i, { category: i.categoryName, pickUpVolume: (i.marketCM ? (Number(i.marketCM) * 100).toFixed(1) : "0.0") + '%', proportion: (i.chain ? (Number(i.chain) * 100).toFixed(1) : "0.0") + '%' }));
                        });
                    }
...
Page(require('./../../../../npm/wepy/lib/wepy.js').default.$createPage(default_1 , 'pages/terminal/report/coverageData/index'));
