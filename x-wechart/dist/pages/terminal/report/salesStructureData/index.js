...
var default_1 = /** @class */ (function (_super) {
    ...
    function default_1() {
        ...
        _this.config = {
            navigationBarTitleText: '产品销售结构报表',
            usingComponents: {
        ...
        _this.methods = {
            ...
            getData: function () {
                _this.methods.getProductSalesStructure(_this.filterForm).then(function (res) {
                    var salesStructureData = res.payload.result;
                    var arr = [];
                    ...
                    _this.salesStructureData = arr;
                    _this.month = res.payload.result.month || {};
                    _this.$apply();
                });
            }
        };
...
Page(require('./../../../../npm/wepy/lib/wepy.js').default.$createPage(default_1 , 'pages/terminal/report/salesStructureData/index'));
