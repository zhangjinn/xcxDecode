...
var default_1 = /** @class */ (function (_super) {
    ...
    function default_1() {
        ...
        _this.methods = {
            ...
            getData: function () {
                _this.methods.getRurnoverRate(_this.filterForm).then(function () {
                    _this.arrDetail = _this.turnoverRateData.arr.map(function (it) {
                        return {
                            title: it.title,
                            a: it.e,
                            b: it.a + '%',
                    ...
                    _this.arrZMDDetail = _this.turnoverRateData.arrZMD.map(function (it) {
                        return {
                            title: it.title,
                            a: it.e,
                            b: it.a + '%',
                    ...
                    if (_this.filterForm.matklCode) {
                        _this.arrDetail.splice(0, 1);
                        _this.arrZMDDetail.splice(0, 1);
                    }
                    _this.$apply();
                });
            }
...
Page(require('./../../../../npm/wepy/lib/wepy.js').default.$createPage(default_1 , 'pages/terminal/report/turnoverRateData/index'));
