...
var todo_1 = require('./../../../store/actions/todo.js');
...
var Todo = /** @class */ (function (_super) {
    ...
    function Todo() {
        ...
        _this.methods = {
            ...
            search: function (params) {
                ...
                _this.methods.getTodoItems(params, function (res) {
                    // 接口返回 关闭对应状态
                    _this.loading = false;
                    _this.isView = false;
    ...
    Todo = __decorate([
        wepy_redux_1.connect({
            ...
            getTodoCounts: todo_1.getTodoCounts,
            getTodoItems: todo_1.getTodoItems,
        })
    ], Todo);
    return Todo;
}(wepy_1.default.page));

Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(Todo , 'pages/me/todo/index'));
