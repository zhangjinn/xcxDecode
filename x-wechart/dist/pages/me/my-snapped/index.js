...
var MySnapped = /** @class */ (function (_super) {
    __extends(MySnapped, _super);
    function MySnapped() {
        ...
        _this.methods = {
            loadNextPage: function () {
                ...
                pagingActivityResult(__assign({}, _this.filterParam));
            },
            // 提交搜索
    ...
    MySnapped.prototype.onShow = function () {
        var pagingActivityResult = this.methods.pagingActivityResult;
        pagingActivityResult(__assign({}, this.filterParam));
    };
    MySnapped.prototype.onUnload = function () {
        this.filterParam = {
            type: '',
            // status: '',
            startDate: '',
...
Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(MySnapped , 'pages/me/my-snapped/index'));
