...
var WebViewPage = /** @class */ (function (_super) {
    ...
    WebViewPage.prototype.onLoad = function (options) {
        if (options.type && options.type == 'toPrivacy') {
        ...
        this.url = wepy_1.default.$appConfig.baseUrl + "/questionnaire/noLoginanswer?questionId=" + this.questionId + "&source=XCX";
...
Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(WebViewPage , 'pages/me/answerNoLogin/index'));
