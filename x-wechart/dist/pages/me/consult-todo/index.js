...
var consultTodo = /** @class */ (function (_super) {
    ...
    function consultTodo() {
        ...
        _this.methods = {
            ...
            search: function (params) {
                ...
                _this.methods.getConsultTodoItems(params, function (res) {
                    // 接口返回 关闭对应状态
                    _this.loading = false;
    ...
    consultTodo = __decorate([
        wepy_redux_1.connect({
            ...
            getConsultTodoCounts: consultTodo_1.getConsultTodoCounts,
            getConsultTodoItems: consultTodo_1.getConsultTodoItems,
        })
    ], consultTodo);
    return consultTodo;
}(wepy_1.default.page));

Page(require('./../../../npm/wepy/lib/wepy.js').default.$createPage(consultTodo , 'pages/me/consult-todo/index'));
