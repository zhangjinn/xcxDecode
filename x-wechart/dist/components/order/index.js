...
var index_2 = require('./../address/index.js');
var index_3 = require('./../search-address/index.js');
var index_4 = require('./../../pages/components/select-address-details/index.js');
...
var Order = /** @class */ (function (_super) {
    ...
    function Order() {
        ...
        _this.$repeat = {};
        _this.$props = { "search": { "title": "请选择" }, "customMarket": { "title": "分销商" }, "customMarketAddress": { "title": "分销商地址" }, "addressDetail": { "xmlns:v-bind": "", "v-bind:chooseRegionId.sync": "chooseRegionId" } };
        _this.$events = {};
        _this.components = {
