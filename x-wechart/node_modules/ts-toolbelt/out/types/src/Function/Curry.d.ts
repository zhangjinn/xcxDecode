 ...
 * ```
 */
export declare type Curry<F extends Function> = <T extends any[]>(...args: Cast<T, Gaps<Parameters<F>>>) => GapsOf<T, Parameters<F>> extends infer G ? G extends [any, ...any[]] ? Curry<(...args: G) => Return<F>> : Return<F> : never;
export {};
