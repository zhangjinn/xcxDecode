...
import { getProductSalesStructure } from '@/store/actions/home'
...
export default class extends wepy.page {
  ...
  methods = {
    ...
    getData: () => {
      this.methods.getProductSalesStructure(this.filterForm).then(res=>{
        const salesStructureData = res.payload.result
        let arr = [];
        ...
        this.salesStructureData = arr;
        this.month = res.payload.result.month||{}
        this.$apply();
      })
    }
  }
