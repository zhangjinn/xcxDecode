...
import { getRurnoverRate } from '@/store/actions/home';
...
export default class extends wepy.page {
  ...
  methods = {
    ...
    getData:()=>{
      this.methods.getRurnoverRate(this.filterForm).then(()=>{
        this.arrDetail=this.turnoverRateData.arr.map(it=>{
          return{
            title:it.title,
            a:it.e,
            b:it.a+'%',
        ...
        this.arrZMDDetail=this.turnoverRateData.arrZMD.map(it=>{
          return{
            title:it.title,
            a:it.e,
            b:it.a+'%',
        ...
        if(this.filterForm.matklCode){
          this.arrDetail.splice(0,1)
          this.arrZMDDetail.splice(0,1)
        }
        this.$apply();
      })
    }
